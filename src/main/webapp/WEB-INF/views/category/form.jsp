...
<div id="here" class="columns">
    ...
    <div class="column is-three-fifths">
        ...
        <div class="notification has-text-centered is-light">
            <strong>Podaj nazwę kategorii</strong>
        </div>
        ...
        <div class="container is-fluid">
            <form:form method="post" modelAttribute="category">
                ...
                <div class="field">
                    <div class="control">
                      <form:input path="name" type="text" placeholder="kategoria herbaty" class="input is-focused"/><br>
                        <form:errors path="name" cssClass="error"/><br>
                        <br>
                        <div class="control">
                            <button class="button is-primary">Dodaj Kategorię</button>
                        </div>
